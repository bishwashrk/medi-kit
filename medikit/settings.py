"""
Django settings for MediKit project.
"""
...
if os.getenv('USE_SQLITE', 'False').lower() in ('true', '1', 'yes'):
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'medikit_db'),
            'USER': os.getenv('DB_USER', 'root'),
            'PASSWORD': os.getenv('DB_PASSWORD', 'medikit_password'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'MediKit API',
    'DESCRIPTION': 'Smart Hospital Management & Appointment Platform API',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'COMPONENT_SPLIT_REQUEST': True,
}

# Logging (minimal for sensitive medical data)
LOGGING = {
    'version': 1,
